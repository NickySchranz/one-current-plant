 ...
 */
const PREFIX = "one-current-plant/table/";
...
export const db = {
  branches: new Table<PsychologicalBranch>("branches"),
  merges: new Table<BranchMerge>("merges"),
  waiting: new Table<WaitingContainer>("waiting"),
